...
export function getPermissionPresetByRole(role: PermissionPresetRole): Record<string, { read: boolean; write: boolean }> {
  ...
  switch (role) {
    ...
    case "Role_Teacher": set(["teacher_classroom","teacher_tasks","teacher_experiment_manager","my_research_groups","resource_center","experiment_square","experiment_catalog","student_tasks","profile","dashboard","textbook_management","experimental_materials","teacher_experiment_preview","teacher_question_bank"],["teacher_classroom","teacher_tasks","teacher_experiment_manager","my_research_groups","student_tasks","experiment_catalog"]); return preset;
