...
export function TeacherMaterialWaterfall(props: Props) {
  ...
  if (props.items.length === 0) {
    return <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-border p-6 text-sm text-muted-foreground">当前筛选无素材条目。</div>;
  }
