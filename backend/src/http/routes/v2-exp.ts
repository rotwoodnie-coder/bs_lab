...
const patchExpMsgReviewSchema = z.object({ status: z.enum(["y", "n"]), confirm_comments: z.string().max(200).nullable().optional(), reject_reason: z.string().nullable().optional() });
