...
/**
 * Sheet
 * Props: 继承 Radix Dialog Root/Content 的能力，额外支持 `side` 定义抽屉方向。
 * 用法: `Sheet + SheetTrigger + SheetContent` 组合；可通过 `SheetHeader/SheetFooter` 组织内容区。
 */
